...
%        showName = {'L lane','R Lane','Straight'};
    ...
    if retrain_models
        for numiter = 1:5
            ...
            save(['observations/learnedModel_' train_model_for '_aiohmm_' num2str(numiter) fname_ext],'learnedModels','testData','trainData','testObs',...
    ...
    accuracy = []; 
        for numiter = 1:5
            load(['observations/learnedModel_' train_model_for '_aiohmm_' num2str(numiter) fname_ext]);
            %{
            if separate_actions
